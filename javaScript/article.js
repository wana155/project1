...
articulos[3].author="Daniel Barrera";articulos[3].title="California Prop 22 Vote Heralds Judgment Day for Uber, DoorDash.";
articulos[3].category="Politics";
articulos[4]=new articles();
articulos[4].author="Daniel Barrera";articulos[4].title="Apple stock pulled down by weak iPhone sales, China.";
articulos[4].category="Business";
articulos[5]=new articles();
articulos[5].author="Daniel Barrera";articulos[5].title="Amazon Earnings, Revenue Beat in Q3 on North America Sales.";
articulos[5].category="Business";
articulos[6]=new articles();
articulos[6].author="Daniel Barrera";articulos[6].title="Big Tech Profits Climb as Ad Sales Pick Up: Live Updates.";
articulos[6].category="Social";
articulos[7]=new articles();
articulos[7].author="Daniel Barrera";articulos[7].title="Here are the highest-paying computer tech jobs in Milwaukee.";
articulos[7].category="Technology";
